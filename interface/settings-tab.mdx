...
<AccordionGroup>
  <Accordion title="Jumper won't accept my license key" icon="face-frown">
...
<Steps>
  <Step title="Visual model selection" icon="robot">
    ...
    <Tip>
      To read more about our machine learning models, click [here](/core-concepts/machine-learning)
    </Tip>
  </Step>
...
You can browse and set a location by clicking the  <Icon icon="folder-open" iconType="regular" color="#fff" size={16} /> Folder button.

You can delete the entire contents of the Analysis by clicking the  <Icon icon="trash-can" iconType="regular" color="#fff" />  Trash button.
